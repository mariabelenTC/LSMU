package marbel.mov.urjc.cuatropixeles;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int tiempo=60000; // tiempo inicial en milisegundos -> 1 minuto = 2*60*1000
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Imagen
        Bitmap bm = BitmapFactory.decodeResource(getResources(), R.drawable.cuatrocolores_r , options);
